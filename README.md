...
| Category | Highlights |
|----------|-----------|
| 🏗️ **Pure C (C99)** | Compiles to a single native binary — zero runtime dependencies |
| 🇮🇳 **Hinglish Syntax** | Keywords in Hindi-English — `maano`, `likho`, `agar`, `jab tak`, `kaam` |
| ⚙️ **Bytecode VM** | Stack-based virtual machine with 44 opcodes for fast execution |
...
| Page | Description |
|------|-------------|
| [🏠 Home](https://rampyaaryans.github.io/rampyaaryan/) | Overview & quick start |
| [🚀 Getting Started](https://rampyaaryans.github.io/rampyaaryan/getting-started.html) | Installation & first program |
...
| [📜 Language Spec](https://rampyaaryans.github.io/rampyaaryan/spec.html) | Formal grammar & syntax rules |
